...
void OpenBCI::testAccel(){
  accel.enable_accel(RATE_25HZ);
  Serial.print("ctrl_1 in testAccel 0x"); Serial.println(accel.LIS3DH_read(CTRL_REG1),HEX);
}
...
byte OpenBCI::defaultChannelBitField(){
  byte bitField = ads.RREG(CH1SET);
  return bitField;
}
